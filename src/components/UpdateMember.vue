    ...
    <div>
      ...
      <form @submit.prevent="updateMember">
        <div class="form-group">
          ...
          <input type="text" id="memberNickname" v-model="member.memberNickname" required />
        </div>
        <div class="form-group">
          <label for="memberAge">나이</label>
          <input type="number" id="memberAge" v-model="member.memberAge" required />
        </div>
        <div class="form-group">
 ...
 /* eslint-disable */
  ...
  export default {
    ...
    methods: {
      ...
      async updateMember() {
        try {
          await axios.put(`/api/members/${this.memberId}`, this.member);
