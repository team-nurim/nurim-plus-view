    ...
    <div class="container">
      ...
      >
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          ...
          <li>
            <router-link to="/recommend-main" class="nav-link px-3"
              >나를 위한 정책지원</router-link
            >
          </li>
          <li>
            <router-link to="/community" class="nav-link px-3"
              >커뮤니티</router-link
            >
          </li>
        ...
        <div class="col-md-3 text-end">
          ...
          <template v-if="!loggedIn">
            <router-link to="/login" class="btn btn-outline-primary btn-sm me-2"
              >로그인</router-link
            >
            <router-link to="/join" class="btn btn-primary btn-sm"
              >회원가입</router-link
            >
          </template>
          <!-- 로그인했을 때 -->
