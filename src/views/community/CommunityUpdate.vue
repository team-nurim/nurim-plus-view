<template>
    <div class="register-container">
        ...
        <div class="form-group">
            <div class="col-md-1">
                <select id="categorySelect" class="form-select" name="category" style="margin-left: 450px; margin-top: 30px;" v-model="communityData.category">
        ...
        <div class="mb-3">
            ...
            <div class="image-list d-flex flex-wrap justify-content-start">
                ...
                <div v-for="(previewImage, index) in previewImages" :key="'preview-' + index" class="image-item mx-2 mb-2">
                    ...
                    <button type="button" class="btn btn-sm" @click="removePreviewImage(index)"><i class="fa-solid fa-trash"></i></button>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row" style="margin-bottom: 20px;">
        <div class="col text-end"> <!-- 버튼을 오른쪽으로 정렬하는 클래스 추가 -->
            <button class="btn btn-secondary" style="margin-right: 10px" @click="cancel">취소하기</button>
            <button class="btn btn-primary" style="margin-right: 140px;" @click="modifyButton">수정하기</button>
        </div>
    </div>
</div>
</div>
